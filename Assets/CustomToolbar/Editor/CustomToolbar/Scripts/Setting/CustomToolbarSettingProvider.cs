...
namespace UnityToolbarExtender
{
    internal class CustomToolbarSettingProvider : SettingsProvider
    {
        ...
        private const string SETTING_PATH = "Assets/Editor/CustomToolbarSettings.asset";

        public CustomToolbarSettingProvider(string path, SettingsScope scopes = SettingsScope.Project) : base(path, scopes)
        {
