...
internal class ToolbarFPSSlider : BaseToolbarElement {
	...
	protected override void OnDrawInToolbar() {
		...
		selectedFramerate = EditorGUILayout.IntSlider("", selectedFramerate, minFPS, maxFPS, GUILayout.Width(WidthInToolbar - 60.0f));
