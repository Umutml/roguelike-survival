        ...
        void UpdateSlider()
        {
            ...
            try
            {
                if (UIManagerAsset.sliderThemeType == UIManager.SliderThemeType.BASIC)
                {
                    ...
                    {
                        popupLabel.color = new Color(UIManagerAsset.sliderPopupLabelColor.r, UIManagerAsset.sliderPopupLabelColor.g, UIManagerAsset.sliderPopupLabelColor.b,
                            popupLabel.color.a);
            ...
            {
                Debug.Log("No UI Manager found, assign it manually.");
            }
        }
    }
}