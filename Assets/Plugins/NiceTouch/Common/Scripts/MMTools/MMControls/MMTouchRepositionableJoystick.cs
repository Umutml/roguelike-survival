...
namespace MoreMountains.Tools
{
    ...
    public class MMTouchRepositionableJoystick : MMTouchJoystick, IPointerDownHandler
    {
        ...
        protected Vector3 _knobInitialPosition;
        ...
        public override void Initialize()
        {
            ...
            _knobInitialPosition = _knobTransform.position;
        }
        ...
        public override void OnPointerDown(PointerEventData data)
        {
            ...
            {
                var distance = Vector3.Distance(_knobInitialPosition, data.position);

                if (distance <= 135 && IsClickableAsButton)
                {
                    _newPosition = _knobInitialPosition;
                }
                else
                {
        ...
        public override void OnPointerUp(PointerEventData eventData)
        {
            ...
            {
                BackgroundCanvasGroup.transform.position = _knobInitialPosition;
                _knobTransform.position = _knobInitialPosition;
            }
        }
