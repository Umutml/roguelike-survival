...
namespace MoreMountains.Tools
{
    ...
    public class MMTouchJoystick : OnScreenControl, IDragHandler, IEndDragHandler, IPointerDownHandler, IPointerUpHandler
    {
        #region MaxRangeModes enum
        ...
        /// <summary>
        /// Custom added extension to support new Input System by Umut/NS
        /// </summary>
        [Tooltip("New Input System Control Path")]
        ...
        [Tooltip("Can we use this as a button?")]
        public bool IsClickableAsButton = false;
        /// <summary>
        /// Custom added extension to support new Input System by Umut/NS
        /// </summary>
        [Tooltip("Button to control")]
        public InputSystemButtonSimulator ButtonSimulatorClickEventSender;
        ...
        public virtual void RefreshMaxRangeDistance()
        {
            ...
            {
                _maxRangeTransformDistance = Vector2.Distance(transform.position, MaxRangeTransform.position);
            }
        }
        ...
        public virtual void OnPointerDown(PointerEventData data)
        {
            ...
            if (IsClickableAsButton)
                ButtonSimulatorClickEventSender.SendButtonDown();
        ...
        public virtual void OnPointerUp(PointerEventData data)
        {
            ...
            if (IsClickableAsButton)
                ButtonSimulatorClickEventSender.SendButtonUp();
